...
describe('Medusa', function() {
  ...
  it('should unstone the the first victim and stone the 4th coming in', function() {
    // create medusa
    var medusa = new Medusa('Wanda');
    // create first victim
    var victim1 = new Person('Steve Rodgers');
    // create second victim
    var victim2 = new Person('Thor');
    // create third victim
    var victim3 = new Person('Bruce Banner');
    // create fourth victim
    var victim4 = new Person('Tony Stark');
